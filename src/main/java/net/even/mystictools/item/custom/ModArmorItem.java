...
import net.even.mystictools.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.AURUM_SOLARIS_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(ModEffects.SOL_INVICTUS, 1200, 0, false, false))).build();
            ...
            if(entity instanceof PlayerEntity player) {
                if(hasFullSuitOfArmorOn(player)) {
                    ...
                    if (timeOfDay >= 6000 && timeOfDay <= 7200) {
                        ...
                        player.removeStatusEffect(ModEffects.SOL_INVICTUS);
                    }
                }
            }
        }
