package net.even.mystictools.entity.client;
...
public class MantisModel<T extends MantisEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer MANTIS = new EntityModelLayer(Identifier.of(MysticTools.MOD_ID, "mantis"), "main");
